...
namespace Caritas.Repository.Migrations
{
    ...
    [Migration("20260609221922_EstoqueModulo")]
    partial class EstoqueModulo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caritas.Models.Entities.CestaBasica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("CestaBasica", (string)null);
                });
            ...
            modelBuilder.Entity("Caritas.Models.Entities.Estoque", b =>
                {
                    ...
                    b.HasIndex("IdItem", "IdParoquia", "Validade", "Lote")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("IdItem", "IdParoquia", "Validade", "Lote"), false);
