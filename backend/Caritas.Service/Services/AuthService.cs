...
{
    public async Task<(bool Success, IEnumerable<string> Errors, Usuario? Usuario)> RegisterAsync(CadastroDto dto)
    {
        ...
        if (!resultado.Succeeded)
            return (false, resultado.Errors.Select(e => e.Description), null);

        return (true, Enumerable.Empty<string>(), usuario);
    }
