...
import type { FecharCaixaModalProps, FecharCaixaModalRef, SessaoCaixaBrecho } from './interface'
...
export const FecharCaixaModal = forwardRef<FecharCaixaModalRef, FecharCaixaModalProps>(
  ({ onSuccess }, ref) => {
          ...
          {sessao && (
            <div className="rounded-lg border bg-muted/40 px-4 py-3 text-sm space-y-1">
              <p>
                ...
                <span className="font-medium">{fmtDateTime(sessao.abertoEm)}</span>
              </p>
              <p>
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <Input
                ...
                placeholder="0,00"
                onChange={(e) => setSaldoFinalContado(Number.parseFloat(e.target.value) || 0)}
              />
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <Button variant="destructive" onClick={handleFechar} disabled={loading}>
