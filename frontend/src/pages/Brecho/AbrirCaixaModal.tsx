...
import type { AbrirCaixaModalProps, AbrirCaixaModalRef, SessaoCaixaBrecho } from './interface'

export const AbrirCaixaModal = forwardRef<AbrirCaixaModalRef, AbrirCaixaModalProps>(
