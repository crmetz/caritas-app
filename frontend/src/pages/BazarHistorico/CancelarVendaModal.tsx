...
import type { CancelarVendaModalProps, CancelarVendaModalRef, VendaBazar } from './interface'
...
export const CancelarVendaModal = forwardRef<CancelarVendaModalRef, CancelarVendaModalProps>(
  ({ onSuccess }, ref) => {
    ...
    const [venda, setVenda] = useState<VendaBazar | null>(null)
    ...
    const handleSubmit = async (e: FormEvent) => {
      ...
      try {
        await APIService.postRequest({
          url: `/bazar/vendas/${venda.id}/cancelar`,
          body: {
            motivo,
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-md">
          ...
          <p className="text-sm text-muted-foreground">
            O estoque das peças será restaurado automaticamente.
          </p>
